...
C     ------------------------------------------------------------------
  ...
  650 FORMAT(1X,38('-'))
  655 FORMAT(1X,24('-'))
  660 FORMAT(/,1X,'SIMULATION TIME HAS BEEN DECREASED TO MINIMIZE',
     &' COMPUTER TIME REQUIRED TO',/,' CALCULATE RESIDUALS.  THE',
     &' REVISED FINAL STRESS PERIOD, NUMBER OF TIME STEPS,',/,' AND',
     &' STRESS-PERIOD LENGTH ARE:',/,3X,'STRESS PERIOD: ',I5,/,3X,
