...
C
     ...
     1 CUMGWI,CUMGWO,CUMSWI,CUMSWO,CUMWDR,CUMFLX,IBOUND)
C
...
C
 ...
 19   FORMAT(//1X,'LAKE PACKAGE ACTIVE:  CALCULATED LAKE STAGE FOR EACH 
     1EACH TIME STEP WILL BE STORED IN HNEW ARRAY.')
...
C12-----RETURN.
      ...
      END
C
      SUBROUTINE GWF1LAK3SFR1RPS(NTRB,NDV,NLAKES,ITRB,IDIV,NSS,IDIVAR,
     1                   IOTSG,IOUT,NODES,RK)
C
C    *******************************************************************
