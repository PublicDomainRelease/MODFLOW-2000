! Time of File Save by ERB: 3/28/2006 12:09PM
C     ******************************************************************
...
C-------ASSIGN VERSION NUMBER AND DATE
      ...
      PARAMETER (VERSION='1.16.00 03/28/2006')
C
...
Cdep  Changed SFR1 call to SFR2 call
     ...
     &             NUMAVE,LCAVDPT,LCUHC,LCSFRUZBD)
        ENDIF
Cdep
CLAK
        IF(IUNIT(22).GT.0)
     ...
     *     LKCUM6,LKCUM7,LKCUM8,LKCUM9,NSSAR,NLAKESAR,IUNIT(46))
CLAK
        IF(IUNIT(46).GT.0)
