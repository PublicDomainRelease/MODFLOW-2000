C     Last change:  ERB  12 Sep 2002    4:21 pm
      SUBROUTINE GWF1BCF6ALP(ISUM,LCSC1,LCHY,LCSC2,LCTRPY,ITRSS,ISS,
     1  IN,NCOL,NROW,NLAY,IOUT,IBCFCB,LCWETD,IWDFLG,LCCVWD,
     2  WETFCT,IWETIT,IHDWET,HDRY,IAPART,IFREFM,LAYHDT)
C
C-----VERSION 11JAN2000 GWF1BCF6ALP
C     ******************************************************************
...
C
C3--6-29-2004--Removed check for too many layers because GLO1BAS6
C3--checks for this.
C
...
C9------RETURN.
      RETURN
      END
      SUBROUTINE GWF1BCF6RPP(IBOUND,HNEW,SC1,HY,CR,CC,CV,DELR,DELC,
     1 SC2,TRPY,IN,ISS,NCOL,NROW,NLAY,IOUT,WETDRY,IWDFLG,CVWD)
C
C-----VERSION 11JAN2000 GWF1BCF6RPP
C     ******************************************************************
