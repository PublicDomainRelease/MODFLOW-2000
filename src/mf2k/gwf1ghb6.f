...
C2------CELL-BY-CELL FLOW TERMS.
      ...
      END IF
      WRITE(IOUT,3) MXACTB
    3 FORMAT(1X,'MAXIMUM OF',I5,' ACTIVE GHB CELLS AT ONE TIME')
...
C6------RETURN
     ...
     1       IFREFM,NCOL,NROW,NLAY,NNPGHB,NPGHB,IGHBPB)
C
...
C3------IF THERE ARE NEW NON-PARAMETER GHB'S, READ THEM.
   ...
   99       FORMAT(1X,/1X,'THE NUMBER OF ACTIVE GHB CELLS (',I4,
     1                     ') IS GREATER THAN MXACTB(',I4,')')
            STOP
         END IF
         CALL ULSTRD(NNPGHB,BNDS,1,NGHBVL,MXBND,IGHBAL,IN,IOUT,
     1      'BOUND. NO. LAYER   ROW   COL     STAGE      CONDUCTANCE',
     2      GHBAUX,5,NAUX,IFREFM,NCOL,NROW,NLAY,5,5,1)
      END IF
      NBOUND=NNPGHB
C
C1C-----IF THERE ARE ACTIVE GHB PARAMETERS, READ THEM AND SUBSTITUTE
      ...
      IF(NP.GT.0) THEN
         NREAD=NGHBVL-IGHBAL
         DO 30 N=1,NP
         CALL UPARLSTSUB(IN,'GHB',IOUT,'GHB',BNDS,NGHBVL,MXBND,NREAD,
     1                MXACTB,NBOUND,5,5,
