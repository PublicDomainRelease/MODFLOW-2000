...
C1------IDENTIFY PACKAGE.
    ...
    1 FORMAT(1X,'HFB6 -- HORIZONTAL FLOW BARRIER',
     &' PACKAGE, VERSION 6, 1/11/1000.',/,'   INPUT READ FROM UNIT',I3)
C
C2------READ AND PRINT NPHFB, MXFB, NHFBNP
  ...
  500 FORMAT(1X,I5,' PARAMETERS DEFINE A MAXIMUM OF ',I5,
     &       ' HORIZONTAL FLOW BARRIERS')
      WRITE(IOUT,530) NHFBNP
  530 FORMAT(1X,I5,' HORIZONTAL FLOW BARRIERS NOT DEFINED BY',
     &       ' PARAMETERS')
C
...
C5------PRINT AMOUNT OF SPACE USED BY HFB PACKAGE.
      WRITE(IOUT,4)ISP
    4 FORMAT(1X,I6,' ELEMENTS IN RX ARRAY ARE USED FOR',
