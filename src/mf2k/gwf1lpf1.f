...
C4------RETURN
     ...
     2 NBOTM,RMLT,IZON,NMLTAR,NZONAR,LAYFLG,BUFF,ITERPK,HNOFLO)
C
...
C3------PREPARE AND CHECK LPF DATA.
     ...
     1       DELC,NCOL,NROW,NLAY,IOUT,WETDRY,BOTM,NBOTM,HNOFLO)
C
C4------RETURN
      RETURN
      END
...
C9------RETURN
     ...
     1        DELR,DELC,NCOL,NROW,NLAY,IOUT,WETDRY,BOTM,NBOTM,HNOFLO)
C
