...
C2------CELL-BY-CELL FLOW TERMS.
      ...
      END IF
      WRITE(IOUT,3) MXACTW
    3 FORMAT(1X,'MAXIMUM OF',I5,' ACTIVE WELLS AT ONE TIME')
...
C1B-----IF THERE ARE NEW NON-PARAMETER WELLS, READ THEM.
   ...
   99       FORMAT(1X,/1X,'THE NUMBER OF ACTIVE WELLS (',I4,
     1                     ') IS GREATER THAN MXACTW(',I4,')')
            STOP
         END IF
         CALL ULSTRD(NNPWEL,WELL,1,NWELVL,MXWELL,IWELAL,IN,IOUT,
     1            'WELL NO.  LAYER   ROW   COL   STRESS RATE',
     2             WELAUX,5,NAUX,IFREFM,NCOL,NROW,NLAY,4,4,1)
      END IF
      NWELLS=NNPWEL
C
C1C-----IF THERE ARE ACTIVE WELL PARAMETERS, READ THEM AND SUBSTITUTE
      ...
      IF(NP.GT.0) THEN
         DO 30 N=1,NP
         CALL UPARLSTSUB(IN,'WEL',IOUT,'Q',WELL,NWELVL,MXWELL,NREAD,
     1                MXACTW,NWELLS,4,4,
