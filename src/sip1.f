...
C
C-----VERSION 1110 31DEC1986 SIP1AL
C
C     ******************************************************************
...
C-----VERSION 1656 24JUL1987 SIP1AP
C
C     ******************************************************************
...
C10-----PRINT HEAD CHANGE EACH ITERATION IF PRINTOUT INTERVAL IS REACHED
     ...
     1      CALL SSIP1P(HDCG,LRCH,KITER,MXITER,IOUT)
C
C11-----RETURN
600   RETURN
C
     ...
     1          IOUT)
C
C-----VERSION 1417 12MAY1987 SSIP1I
C     ******************************************************************
...
C5------RETURN
      RETURN
      END
      SUBROUTINE SSIP1P(HDCG,LRCH,KITER,MXITER,IOUT)
C
C
C-----VERSION 1636 24JUL1987 SSIP1P
C     ******************************************************************
